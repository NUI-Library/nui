...
var UIContext = React2.createContext({
  theme: defaultTheme,
  setColorScheme: () => {
  },
  toggleColorScheme: () => {
...
function createUI(config = {}) {
  ...
  function Provider({ children }) {
    const [colorScheme, setColorScheme] = React2.useState(
    ...
    const toggleColorScheme = React2.useCallback(() => {
      setColorScheme((prev) => prev === "light" ? "dark" : "light");
    }, []);
    const cssVars = React2.useMemo(() => generateCSSVariables(theme), [theme]);
    const styleString = React2.useMemo(() => cssVariablesToString(cssVars), [cssVars]);
  ...
  ${styleString}
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(UIContext.Provider, { value: contextValue, children: /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        "data-nui": instanceId,
...
function useUI() {
  const context = React2.useContext(UIContext);
  if (!context) {
...
function Spinner({ size }) {
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("style", { children: `@keyframes nui-spin { to { transform: rotate(360deg); } }` }),
...
function ButtonInner(props, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    Component,
    {
      ...
      ...rest,
      children: [
        loading && /* @__PURE__ */ jsxRuntime.jsx("span", { style: styles.loader, children: /* @__PURE__ */ jsxRuntime.jsx(Spinner, { size: spinnerSize }) }),
        /* @__PURE__ */ jsxRuntime.jsxs("span", { style: styles.inner, children: [
          leftIcon && /* @__PURE__ */ jsxRuntime.jsx("span", { style: { display: "flex" }, children: leftIcon }),
          children,
          rightIcon && /* @__PURE__ */ jsxRuntime.jsx("span", { style: { display: "flex" }, children: rightIcon })
        ] })
      ]
    }
  );
}
var Button = React2__default.default.forwardRef(ButtonInner);
...
var Input = React2__default.default.forwardRef(
  function Input2(props, ref) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.root, children: [
      label && /* @__PURE__ */ jsxRuntime.jsxs("label", { htmlFor: inputId, style: styles.label, children: [
        label,
        required && /* @__PURE__ */ jsxRuntime.jsx("span", { style: { color: "var(--nui-color-red-6, #fa5252)", marginLeft: "0.25rem" }, children: "*" })
      ] }),
      description && /* @__PURE__ */ jsxRuntime.jsx("p", { id: descriptionId, style: styles.description, children: description }),
      /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.inputWrapper, children: [
        leftSection && /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.leftSection, children: leftSection }),
        /* @__PURE__ */ jsxRuntime.jsx(
          "input",
          {
            ref,
        ...
        rightSection && /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.rightSection, children: rightSection })
      ] }),
      error && /* @__PURE__ */ jsxRuntime.jsx("p", { id: errorId, role: "alert", style: styles.error, children: error })
    ] });
  }
);
...
var Card = React2__default.default.forwardRef(
  function Card2(props, ref) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("div", { ref, style: { ...styles.root, ...userStyle }, ...rest, children });
  }
);
...
function Modal(props) {
  ...
  const [isAnimatingIn, setIsAnimatingIn] = React2.useState(false);
  ...
  const modalContent = /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs("div", { ref: contentRef, style: styles.content, children: [
        (title || withCloseButton) && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.header, children: [
          title && /* @__PURE__ */ jsxRuntime.jsx("h2", { id: "nui-modal-title", style: styles.title, children: title }),
        ...
        /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.body, children })
      ] })
    }
  );
...
var Badge = React2__default.default.forwardRef(
  function Badge2({ variant = "filled", size = "md", radius = "xl", color = "primary", children, ...rest }, ref) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("span", { ref, style: styles.root, ...rest, children });
  }
);
...
function Tabs({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.root, children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.list, role: "tablist", children: items.map((item) => {
...
function TabsPanel({ value, activeValue, children }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { role: "tabpanel", style: { padding: "1rem 0" }, children });
}
...
function Breadcrumb({ items, separator = "/" }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("nav", { "aria-label": "Breadcrumb", style: styles.root, children: items.map((item, index) => {
    const isLast = index === items.length - 1;
    return /* @__PURE__ */ jsxRuntime.jsxs(React2__default.default.Fragment, { children: [
      isLast ? /* @__PURE__ */ jsxRuntime.jsx("span", { style: { ...styles.item, ...styles.itemActive }, children: item.label }) : item.href ? /* @__PURE__ */ jsxRuntime.jsx("a", { href: item.href, style: styles.item, children: item.label }) : /* @__PURE__ */ jsxRuntime.jsx(
        "button",
        {
      ...
      !isLast && /* @__PURE__ */ jsxRuntime.jsx("span", { style: styles.separator, children: separator })
    ] }, index);
  }) });
}
...
function Divider({
  ...
  if (orientation === "vertical") {
    return /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.root, role: "separator", "aria-orientation": "vertical" });
  }
  if (!label) {
    return /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.line, role: "separator" });
  }
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.root, role: "separator", children: [
    labelPosition !== "left" && /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.line }),
    /* @__PURE__ */ jsxRuntime.jsx("span", { style: styles.label, children: label }),
    labelPosition !== "right" && /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.line })
  ] });
}
...
function Skeleton({
  ...
  if (children) {
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { position: "relative" }, children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { style: { visibility: visible ? "hidden" : "visible" }, children }),
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.root });
}
...
function Switch({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("label", { style: styles.root, onClick: handleClick, children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.track, role: "switch", "aria-checked": checked, tabIndex: disabled ? -1 : 0, onKeyDown: (e) => {
      if (e.key === " " || e.key === "Enter") {
        e.preventDefault();
        handleClick();
      }
    }, children: /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.thumb }) }),
    label && /* @__PURE__ */ jsxRuntime.jsx("span", { style: styles.label, children: label })
  ] });
}
...
function ToastItem({ data, onDismiss }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.root, children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.indicator }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.content, children: [
      data.title && /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.title, children: data.title }),
      /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.message, children: data.message })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx("button", { style: styles.closeBtn, onClick: () => onDismiss(data.id), "aria-label": "Dismiss", children: /* @__PURE__ */ jsxRuntime.jsxs("svg", { width: "12", height: "12", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
...
function ToastProvider({
  ...
  const [mounted, setMounted] = React2.useState(false);
  const idCounter = React2.useRef(0);
  React2.useEffect(() => {
    setMounted(true);
  }, []);
  const show = React2.useCallback((toast) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ToastContext.Provider, { value: { show }, children: [
    children,
    mounted && reactDom.createPortal(
      /* @__PURE__ */ jsxRuntime.jsx("div", { style: { ...containerStyles.root, zIndex }, children: toasts.map((t) => /* @__PURE__ */ jsxRuntime.jsx(ToastItem, { data: t, onDismiss: dismiss }, t.id)) }),
      document.body
    )
  ] });
}
...
var Avatar = React2__default.default.forwardRef(
  function Avatar2({ src, alt, name, size = "md", radius = "full", color = "primary", children, ...rest }, ref) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("div", { ref, style: styles.root, ...rest, children: showImage ? /* @__PURE__ */ jsxRuntime.jsx("img", { src, alt: alt || name || "", style: styles.image, onError: () => setImgError(true) }) : fallback });
  }
);
...
function Tooltip({ label, position = "top", disabled = false, children }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("span", { style: styles.wrapper, onMouseEnter: () => setVisible(true), onMouseLeave: () => setVisible(false), onFocus: () => setVisible(true), onBlur: () => setVisible(false), children: [
    children,
    visible && /* @__PURE__ */ jsxRuntime.jsx("span", { style: styles.tooltip, role: "tooltip", children: label })
  ] });
}
...
function Progress({ value, size = "md", radius = "xl", color = "primary", striped = false, animated = false, label }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.root, role: "progressbar", "aria-valuenow": value, "aria-valuemin": 0, "aria-valuemax": 100, children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.bar }),
    label && /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.label, children: label })
  ] });
}
...
function Alert({ variant = "subtle", color = "blue", radius = "md", title, icon, withCloseButton, onClose, children }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.root, role: "alert", children: [
    icon && /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.icon, children: icon }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.body, children: [
      title && /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.title, children: title }),
      /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.message, children })
    ] }),
    withCloseButton && /* @__PURE__ */ jsxRuntime.jsx("button", { style: styles.closeBtn, onClick: onClose, "aria-label": "Close", children: /* @__PURE__ */ jsxRuntime.jsxs("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
      /* @__PURE__ */ jsxRuntime.jsx("line", { x1: "18", y1: "6", x2: "6", y2: "18" }),
      /* @__PURE__ */ jsxRuntime.jsx("line", { x1: "6", y1: "6", x2: "18", y2: "18" })
    ] }) })
  ] });
...
var TextArea = React2__default.default.forwardRef(
  function TextArea2({ label, description, error, size = "md", radius = "md", disabled, rows = 4, ...rest }, ref) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.root, children: [
      label && /* @__PURE__ */ jsxRuntime.jsx("label", { style: styles.label, children: label }),
      description && /* @__PURE__ */ jsxRuntime.jsx("p", { style: styles.description, children: description }),
      /* @__PURE__ */ jsxRuntime.jsx("textarea", { ref, style: styles.input, disabled, rows, ...rest }),
...
function Accordion({ items, variant = "default", radius = "md", multiple = false, defaultValue = [] }) {
  const [openItems, setOpenItems] = React2.useState(defaultValue);
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.root, children: items.map((item) => {
    const isOpen = openItems.includes(item.value);
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.item, children: [
      /* @__PURE__ */ jsxRuntime.jsxs("button", { style: styles.control, onClick: () => !item.disabled && toggle(item.value), disabled: item.disabled, "aria-expanded": isOpen, children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { children: item.label }),
        /* @__PURE__ */ jsxRuntime.jsx("span", { style: { ...styles.chevron, ...isOpen ? styles.chevronOpen : {} }, children: /* @__PURE__ */ jsxRuntime.jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M6 9l6 6 6-6" }) }) })
      ] }),
      isOpen && /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.panel, children: item.content })
    ] }, item.value);
  }) });
}
...
var ActionIcon = React2__default.default.forwardRef(
  function ActionIcon2({ variant = "subtle", size = "md", radius = "md", color = "primary", disabled, children, ...rest }, ref) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("button", { ref, style: styles.root, disabled, ...rest, children });
  }
);
...
function Stack({ gap = "md", align = "stretch", justify = "flex-start", children }) {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "flex", flexDirection: "column", alignItems: align, justifyContent: justify, gap: gapMap2[gap] || gap }, children });
}
...
function Text({ size = "md", color, weight, align, lineClamp, truncate, inline, children }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Tag, { style, children });
}
...
var Anchor = React2__default.default.forwardRef(
  function Anchor2({ size = "md", color = "primary", underline = "hover", children, style, ...rest }, ref) {
    return /* @__PURE__ */ jsxRuntime.jsx("a", { ref, style: {
...
function Loader({ size = "md", color = "primary" }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("svg", { width: dim, height: dim, viewBox: "0 0 38 38", xmlns: "http://www.w3.org/2000/svg", style: { animation: "nui-spin 1s linear infinite" }, children: /* @__PURE__ */ jsxRuntime.jsx("g", { fill: "none", fillRule: "evenodd", children: /* @__PURE__ */ jsxRuntime.jsxs("g", { transform: "translate(1 1)", strokeWidth: "3", children: [
    /* @__PURE__ */ jsxRuntime.jsx("circle", { strokeOpacity: ".25", cx: "18", cy: "18", r: "18", stroke: `var(--nui-color-${color}-6)` }),
    /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M36 18c0-9.94-8.06-18-18-18", stroke: `var(--nui-color-${color}-6)`, strokeLinecap: "round" })
  ] }) }) });
}
...
function Chip({ checked = false, onChange, size = "md", radius = "xl", color = "primary", variant = "outline", disabled, children }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("button", { style: styles.root, onClick: () => !disabled && onChange?.(!checked), disabled, role: "checkbox", "aria-checked": checked, children: [
    checked && /* @__PURE__ */ jsxRuntime.jsx("svg", { style: styles.check, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "3", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsxRuntime.jsx("polyline", { points: "20 6 9 17 4 12" }) }),
    children
  ] });
}
